                ...
                scope.getidentitybylogin = function () {
                    return utils.ajax({
                        ...
                        if (scope.listidentity.identitys) {
                            scope.listidentity.identitys.forEach(identity => {
                                identity.posts.forEach(post => {
                                    if (post.id == "clgly") {
                                       // scope.isclgly = true;
                                        // if (scope.isclgly) {
                                        //     scope.widthclass = "col-xs-12 col-sm-12 col-md-6 col-lg-6";
                                        // }
