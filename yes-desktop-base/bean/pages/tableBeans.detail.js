define(function() {
    angular.module('app').controller('bean.tableBeans.detail',
            ...
            scope.action = {
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        utils.ajax({
                            method: 'DELETE',
                            url: "bean/tableBeans/" + scope.model.uid,
                            mockUrl: "plugins/data/tableBeans.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.model = {
                            ...
                            scope.refreshtab("refreshtableBeans", {});
