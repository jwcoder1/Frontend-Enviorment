define(function() {
    angular.module('app').controller('bean.singletconfigure.detail',
                            ...
                            items: [{
                                ...
                                },
                                {
                                    ...
                                    onchange: function(item) {
                                        scope.model.fileName = scope.model.entityNamea + ".detail";
                                    }
                                                        ...
                                                        qwsys.getdocuments("getfieldInfos", paras, function(selectmodel) {
                                                            ...
                                                            selectmodel.records.forEach(function(element) {
                                                                var item = {
                                                                    ...
                                                                    discretenessno: element.fdiscretenessno,
                                                                    lovType: element.flovType,
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        utils.ajax({
                            ...
                            mockUrl: "plugins/data/singletconfigure.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.model = {
