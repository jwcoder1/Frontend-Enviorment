define(function() {
    angular.module('app').controller('bean.test.detail',
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        scope.promise = utils.ajax({
                            method: 'DELETE',
                            url: "bean/test/" + scope.model.uid,
                            mockUrl: "plugins/data/test.detail.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.model = {
