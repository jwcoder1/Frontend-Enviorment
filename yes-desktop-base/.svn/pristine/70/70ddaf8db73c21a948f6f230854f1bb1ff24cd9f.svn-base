(function() {
        ...
        var view = {
            ...
            load: function() {
                utils.ajax({
                    ...
                    var colors = ['danger', 'primary', 'success', 'info', 'warning', 'danger', 'primary', 'success', 'info', 'warning', 'danger', 'primary', 'success', 'info', 'warning', 'danger'];
    ...
    angular.module('app').controller('app.home.bak', controller);
