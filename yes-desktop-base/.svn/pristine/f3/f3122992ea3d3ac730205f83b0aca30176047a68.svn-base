define(function() {
    angular.module('app').controller('bean.lovtype.detail',
            ...
            scope.action = {
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        utils.ajax({
                            method: 'DELETE',
                            url: "bean/lovtype/" + scope.model.uid,
                            mockUrl: "plugins/data/lovtype.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.model = {
                            ...
                            scope.refreshtab("refreshlovtype", {});
