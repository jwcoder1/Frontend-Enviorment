define(function() {
    angular.module('app').controller('bean.threeconfigure.detail',
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        utils.ajax({
                            ...
                            mockUrl: "plugins/data/threeconfigure.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.model = {
